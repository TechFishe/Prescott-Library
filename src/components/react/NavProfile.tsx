...
export default function NavProfile(){
    ...
    return(
        <a href="/user" className={`mdTall:ml-8 border border-transparent hover:border-[#E9EDDE]/25 group ${Object.keys(user).length === 0 ? "mdTall:px-2" : "mdTall:px-5"} mdTall:py-1 rounded-lg space-x-1 hover:scale-[1.025] transition-all ease-in flex mdTall:flex-row flex-col items-center justify-center`}>
